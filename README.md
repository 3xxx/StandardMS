...
80端口的好处是浏览器默认的端口，不用输。比如访问192.168.9.13:80只要在浏览器输入192.168.9.13即可。

管理员登陆用户名为admin，密码为admin

其他设计院人员用户名为汉语拼音姓全拼+点号.+名的首字母。如qin.xc，密码也是qin.xc
...
[
	{	
		"username": "秦晓川",
		"serviceAPI": "http://192.168.9.13",
		"port": "80"
	},
	{	
		"username": "qingo",
		"serviceAPI": "http://172.168.9.13",
		"port": "8080"
	}	
]
...
局域网内外需通过VPN进行连接。www.gpdiwe.com上有vpn的入口，用户名和密码是自己电脑登陆gpdiwe域的登陆名和密码。
