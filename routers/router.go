...
func init() {
	...
	beego.Router("/", &controllers.StandardController{}, "*:Index")
	beego.Router("/search", &controllers.StandardController{}, "*:Search")
	beego.Router("/importexcel", &controllers.StandardController{}, "*:ImportExcel")
	beego.Router("/standard_one_addbaidu", &controllers.StandardController{}, "post:Standard_one_addbaidu")
	beego.Router("/importlibrary", &controllers.StandardController{}, "post:ImportLibrary")
	//显示规范所有
	beego.Router("/getstandard", &controllers.StandardController{}, "get:GetStandard")
	//修改规范库
	beego.Router("/updatestandard", &controllers.StandardController{}, "post:UpdateStandard")
	//删除规范库
	beego.Router("/deletestandard", &controllers.StandardController{}, "post:DeleteStandard")

	//显示有效库所有
	beego.Router("/valid", &controllers.StandardController{}, "get:Valid")
	//删除有效库中选中
	beego.Router("/deletevalid", &controllers.StandardController{}, "post:DeleteValid")
