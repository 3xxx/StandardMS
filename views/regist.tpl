...
<!--   <form method="POST" action="/login">
    <div class="form-group">
      <label>Acount</label>
      <input  class="form-control" id="uname" placeholder="Enter account" name="uname"></div>
    <div class="form-group">
      <label>Password</label>
      <input type="password" class="form-control" id="pwd" placeholder="Password" name="pwd"></div>

    <div class="checkbox">
      <label>
        <input type="checkbox">自动登陆</label>
    </div>
    <button type="submit" class="btn btn-default" onclick="return checkInput();">登陆</button>
    ...
    <form method="POST" action="/regist">
      ...
      -->
      <div class="form-group">
        <label class="control-label" id="regis" for="LoginForm-UserName">用户名 或 邮箱</label>
