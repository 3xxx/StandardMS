      ...
      <table class="table table-striped">
       <thead>
         <tr>
           ...
           <th style="cursor: pointer">项目简介</th>
       ...
       <tbody>
         ...
         <th><a href="/category/viewbrief?id={{.Id}}" id="name" target="_black"><i class="glyphicon glyphicon-plane"></i>项目简介</a></th>
         <th>{{.Author}}</th>
         <th>{{.TopicCount}}</th>
